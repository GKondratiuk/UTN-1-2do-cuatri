class Persona: #Creamos una clase
    ...
    def __init__(self, nombre, apellido, edad,*args,**kwargs): #Metodo para inicializar objetos se lo llama metodo init dunder
        #*args agrega tupla
...
persona3 = Persona('Rogelio','Romero',22,'Telefno','2614445557','Calle Lopez',823,'Manzana',77,'Casa',18,Altura=1.83,Peso=185,CFavorito='Azul',Auto='Citroen',Modelo = 2021)
