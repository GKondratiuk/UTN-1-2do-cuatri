...
y mezclarlos en una tercera tabla de la siguiente forma:
...
public class Arreglos_Ejercicio_2 {
    public static void main(String[] args) {
        ...
        System.out.println("Llenamos el primer arreglos: ");
        for (int i = 0; i < 10; i++) {
            System.out.print((i+1)+". Digite el primer numero: ");
            numeros1[i] = entrada.nextInt();
        }
        
        System.out.println("Llenamos el segundo arreglo: ");
        for (int i = 0; i < 10; i++) {
            System.out.print((i+1)+". Digite el segundo numero: ");
